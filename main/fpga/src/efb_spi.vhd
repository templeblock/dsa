...
-- Module  Version: 1.1
--/home/ubuntu/Downloads/diamond/usr/local/diamond/3.0/ispfpga/bin/lin/scuba -w -n efb_spi -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 133 -spi -spi_mode Slave -wb -dev 7000 -e 

-- Wed Apr  2 23:33:57 2014
...
begin
    ...
    EFBInst_0: EFB
        ...
        SPI_LSB_FIRST=> "DISABLED", SPI_CLK_DIVIDER=>  3, SPI_MODE=> "SLAVE", 
        ...
        EFB_I2C1=> "DISABLED", EFB_WB_CLK_FREQ=> "88.67")
