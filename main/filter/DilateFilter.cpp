 ...
 */
dsa::DilateFilter::DilateFilter(cv::Mat element, cv::Point anchor, int iterations, int borderType, const cv::Scalar& borderValue) {
	element_ = element;
	anchor_ = anchor;
